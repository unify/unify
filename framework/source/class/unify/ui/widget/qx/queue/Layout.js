 ...
 */
qx.Class.define("unify.ui.widget.qx.queue.Layout",
{
  statics :
  {
    ...
    add : function(widget)
    {
      ...
      unify.ui.widget.qx.queue.Manager.scheduleFlush("layout");
    },
...
console.log("Flush: ", queue);
    ...
    {
      var VisibilityQueue = unify.ui.widget.qx.queue.Visibility;
