 ...
 */
qx.Class.define("unify.ui.widget.qx.queue.Manager",
{
  statics :
  {
    ...
    scheduleFlush : function(job)
    {
      ...
      var self = unify.ui.widget.qx.queue.Manager;
    ...
    flush : function()
    {
      if (unify.ui.widget.qx.queue.Manager.PAUSE) {
        return;
      }
      ...
      self.__executeAndRescheduleOnError(function()
      {
        ...
        while (jobs.visibility || jobs.widget || jobs.appearance || jobs.layout || jobs.element)
        {
          ...
          {
            delete jobs.widget;
            unify.ui.widget.qx.queue.Widget.flush();
          }

          if (jobs.visibility)
          {
            delete jobs.visibility;
            unify.ui.widget.qx.queue.Visibility.flush();
          }
          ...
          {
            delete jobs.layout;
            unify.ui.widget.qx.queue.Layout.flush();
          }
...
//            qx.html.Element.flush();
      ...
      self.__executeAndRescheduleOnError(function()
      {
        ...
        {
          delete jobs.dispose;
          unify.ui.widget.qx.queue.Dispose.flush();
        }
      }, function() {
        // Clear flag
    ...
    {
      var statics = unify.ui.widget.qx.queue.Manager;
