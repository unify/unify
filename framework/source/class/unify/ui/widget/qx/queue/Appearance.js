 ...
 * state changes.
 */
qx.Class.define("unify.ui.widget.qx.queue.Appearance",
{
  statics :
  {
    ...
    add : function(widget)
    {
      ...
      unify.ui.widget.qx.queue.Manager.scheduleFlush("appearance");
    },
     ...
     *
     * This is used exclusively by the {@link unify.ui.widget.qx.queue.Manager}.
     *
     * @return {void}
     */
    flush : function()
    {
      var Visibility = unify.ui.widget.qx.queue.Visibility;
