 ...
 */
core.Class("unify.ui.layout.Grid", {
  ...
  members :
  {
    ...
    _fixHeightsRowSpan : function(rowHeights)
    {
      ...
      for (var i=0, l=this.__rowSpans.length; i<l; i++)
      {
        ...
        {
          if (!Object.isEmpty(rowFlexes)) {
            var rowIncrements = unify.ui.layout.Util.computeFlexOffsets(
    ...
    _fixWidthsColSpan : function(colWidths)
    {
      ...
      for (var i=0, l=this.__colSpans.length; i<l; i++)
      {
        ...
        {
          var colIncrements = unify.ui.layout.Util.computeFlexOffsets(
    ...
    _getColumnFlexOffsets : function(width)
    {
      ...
      return unify.ui.layout.Util.computeFlexOffsets(flexibles, width, hint.width);
    },
    ...
    _getRowFlexOffsets : function(height)
    {
      ...
      return unify.ui.layout.Util.computeFlexOffsets(flexibles, height, hint.height);
    },
    ...
    {
      unify.ui.layout.Base.prototype.invalidateLayoutCache.call(this);
