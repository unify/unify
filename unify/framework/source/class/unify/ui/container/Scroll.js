...
qx.Class.define("unify.ui.container.Scroll", {
  ...
  construct : function(layout) {
    ...
    var thickness =unify.ui.container.scroll.Indicator.THICKNESS;
  ...
  */
  ...
  members: {
    ...
    */
    ...
    __scrollIndicatorX : null,
    __scrollIndicatorY : null,
    ...
    */
    ...
    reflow : function()
    {
      ...
      this.__contentWidth = Math.max(this.__clientWidth, contentElem.getElement().offsetWidth); // TODO  remove getElement()
      this.__contentHeight = Math.max(this.__clientHeight, contentElem.getElement().offsetHeight); // TODO  remove getElement()
